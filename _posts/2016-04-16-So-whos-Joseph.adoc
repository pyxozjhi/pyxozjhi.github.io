...
I'm an *IT professional* living in *San Francisco*. This blog will center mostly around my beginnings in cybersecurity, namely reversing and packet analysis.
